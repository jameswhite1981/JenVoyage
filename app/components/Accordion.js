...
export default function Accordion({ title, subtitle, defaultOpen = false, onRemove, children }) {
      ...
      >
        ...
        {onRemove && (
          <button
            ...
            style={{ ...sans, background:"none", border:"none", color:"#9B3A2A", fontSize:"0.68rem", fontWeight:500, letterSpacing:"0.05em", textTransform:"uppercase", cursor:"pointer", padding:"0.2rem 0.4rem", flexShrink:0 }}
          >
            Remove
          </button>
        )}
