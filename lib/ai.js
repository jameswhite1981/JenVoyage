...
9. Include a "costSummary" as an ordered list of line items (e.g. flights, accommodation, excursions, transfers, total, per person) — mirror how a real quote is broken down, including variants like "(with villa) / (with hotel)" if accommodation options diverge significantly in price.
...
Respond ONLY with this JSON, no markdown, no preamble:
{
  ...
  "costSummary": [{"label":"Total flights (estimated)","value":"£X,XXX"},{"label":"Per person (approx.)","value":"£X,XXX"}],
